...
var htmlModules = require('./htmlModules.js'); // const sidebar = require('./sidebar.js');
// 主题配置
...
module.exports = {
  ...
  footer: {
    ...
    createYear: 2021,
    // 博客创建年份
    copyrightInfo: 'Coderhyp | <a href="https://github.com/Coderhyp/hypecode" target="_blank">GITHUB</a>' // 博客版权信息，支持a标签

  },
  htmlModules: htmlModules // 插入hmtl(广告)模块
